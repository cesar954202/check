    ...
    <body>
      ...
      <nav>
        <div class="nav-wrapper grey darken-4">
          <a href="#!" class="brand-logo">Agregar Pantalla</a>
          <ul class="right hide-on-med-and-down">
            <li><a class="dropdown-button" href="../monitorIndex.php" ><i class="material-icons">arrow_back
</i></a></li>
          </ul>
        </div>
      </nav>
