    ...
    <body>
      ...
      <nav>
        <div class="nav-wrapper grey darken-4">
          <a href="#!" class="brand-logo">Editar Servidor</a>
      ...
      <div class="container grey darken-4">
        ...
        <div class="row">
          <form action="Form_EditarServidor.php" method="post">
            <div class="input-field col s6 offset-s3 white-text">
              ...
              <div class="row">
              <br>
              <button class="btn waves-effect waves-light grey col s2 offset-s7" type="submit" name="action">Editar
