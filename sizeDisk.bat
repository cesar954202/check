...
wmic /node:10.156.113.161 /user:mexhadmn\gdlha_interface /password:pr3s1d3nt3 logicaldisk where DeviceID='C:' get freespace > C_GDL_INTERFACES%Date:~6,4%-%Date:~3,2%-%Date:~0,2%.txt
wmic /node:10.156.113.161 /user:mexhadmn\gdlha_interface /password:pr3s1d3nt3 logicaldisk where DeviceID='D:' get freespace > D_GDL_INTERFACES%Date:~6,4%-%Date:~3,2%-%Date:~0,2%.txt
wmic /node:10.156.113.47 /user:mexhadmn\gdlha_tarificador /password:Presidente2018 logicaldisk where DeviceID='C:' get freespace > C_SRVGDLTAR%Date:~6,4%-%Date:~3,2%-%Date:~0,2%.txt
wmic /node:10.156.113.47 /user:mexhadmn\gdlha_tarificador /password:Presidente2018 logicaldisk where DeviceID='D:' get freespace > D_SRVGDLTAR%Date:~6,4%-%Date:~3,2%-%Date:~0,2%.txt
...
wmic /node:10.156.113.192 /user:.\administrador /password:pr3s1d3nt3 logicaldisk where DeviceID='C:' get freespace > C_GDLHA_OPERADORA%Date:~6,4%-%Date:~3,2%-%Date:~0,2%.txt
wmic /node:10.156.113.192 /user:.\administrador /password:pr3s1d3nt3 logicaldisk where DeviceID='D:' get freespace > D_GDLHA_OPERADORA%Date:~6,4%-%Date:~3,2%-%Date:~0,2%.txt
wmic /node:10.156.113.116 /user:mexhadmn\carlos_pacheco /password:Yamileth03* logicaldisk where DeviceID='c:' get freespace > c_cpacheco%Date:~6,4%-%Date:~3,2%-%Date:~0,2%.txt
...
systeminfo /s 10.156.113.161 /u mexhadmn\gdlha_interface /p pr3s1d3nt3 | find "Tiempo" > GDL_INTERFACES_T_%Date:~6,4%-%Date:~3,2%-%Date:~0,2%.txt
systeminfo /s 10.156.113.47 /u mexhadmn\gdlha_tarificador /p Presidente2018 | find "Tiempo" > SRVGDLTAR_T_%Date:~6,4%-%Date:~3,2%-%Date:~0,2%.txt
...
systeminfo /s 10.156.113.116 /u mexhadmn\carlos_pacheco /p Yamileth03* | find "Tiempo" > cpacheco_T_%Date:~6,4%-%Date:~3,2%-%Date:~0,2%.txt
